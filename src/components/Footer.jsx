        ...
        <div className='w-full h-screen bg-zinc-900 p-20 flex gap-5'>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div className="heading">
                    <h1 className='text-[6vw] uppercase font-semibold leading-none tracking-tighter'>EYE-</h1>
                    <h1 className='text-[6vw] uppercase font-semibold leading-none tracking-tighter'>OPENNING</h1>
                </div>
                <div>
            ...
            <div className='w-1/2'>
                <h1 className='text-[6vw] uppercase font-semibold leading-none tracking-tighter'>
                    PRESENTATIONS
                </h1>
